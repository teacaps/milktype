...
export const meta: MetaFunction = () => [
	...
	{
		property: "og:url",
		content: "https://milktype.co/terms",
	},
	{
		property: "og:image",
...
export default function Terms() {
	return (
		<Layout>
			<Container className="prose prose-h1:text-3xl prose-h1:text-cocoa-100 prose-h1:font-semibold prose-h2:mt-0 prose-h2:text-lg prose-p:text-lg py-8 sm:py-16 text-cocoa-120">
				<h1>terms of service</h1>
				<h2>Overview</h2>
				<p>
					This website is operated by Milktype. Throughout the site, the terms “we”, “us” and “our” refer to
					Milktype. Milktype offers this website, including all information, tools and services available from
					this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and
					notices stated here. By visiting our site and/or purchasing something from us, you engage in our
					...
					who are browsers, vendors, customers, merchants, and/ or contributors of content. Please read these
					Terms of Service carefully before accessing or using our website. By accessing or using any part of
					the site, you agree to be bound by these Terms of Service. If you do not agree to all the terms and
					conditions of this agreement, then you may not access the website or use any services. If these
				...
				<p>
					...
					Return Policy. We have made every effort to display as accurately as possible the colors and images
					of our products that appear at the store. We cannot guarantee that your computer monitor's display
					of any color will be accurate. We reserve the right, but are not obligated, to limit the sales of
					our products or Services to any person, geographic region or jurisdiction. We may exercise this
					right on a case-by-case basis. We reserve the right to limit the quantities of any products or
					services that we offer. All descriptions of products or product pricing are subject to change at
					anytime without notice, at the sole discretion of us. We reserve the right to discontinue any
					product at any time. Any offer for any product or service made on this site is void where
					prohibited. We do not warrant that the quality of any products, services, information, or other
					material purchased or obtained by you will meet your expectations, or that any errors in the Service
					will be corrected.
				</p>
				...
				<p>
					...
					judgment, appear to be placed by dealers, resellers or distributors. You agree to provide current,
					complete and accurate purchase and account information for all purchases made at our store. You
					agree to promptly update your account and other information, including your email address and credit
					card numbers and expiration dates, so that we can complete your transactions and contact you as
				...
				<p>
					...
					third-party tools. Any use by you of optional tools offered through the site is entirely at your own
					...
					new services and/or features through the website (including, the release of new tools and
				...
				<p>
					...
					non-infringement. In no case shall Milktype, our directors, officers, employees, affiliates, agents,
					...
					or otherwise made available via the service, even if advised of their possibility. Because some
					states or jurisdictions do not allow the exclusion or the limitation of liability for consequential
					or incidental damages, in such states or jurisdictions, our liability shall be limited to the
					maximum extent permitted by law.
				</p>
				<h2>Section 14 - Indemnification</h2>
				<p>
					You agree to indemnify, defend and hold harmless Milktype and our parent, subsidiaries, affiliates,
				...
				<p>
					...
					by and construed in accordance with the laws of Millbrae, CA, 94030, United States.
				</p>
				...
				<p>Questions about the Terms of Service should be sent to us at hi@milktype.co.</p>
				<h2>Privacy Policy</h2>
				<p>
					This Privacy Policy describes how your personal information is collected, used, and shared when you
					visit or make a purchase from milktype.co (the “Site”).
				</p>
				...
				<p>
					...
					type, Internet service provider, referring/exit pages, and date/time stamps. “Web beacons”, “tags”,
					and “pixels” are electronic files used to record information about how you browse the Site.
					...
					information as “Order Information.” When we refer to “Personal Information” in this Privacy Policy,
					we are referring to both Device Information and Order Information.
				</p>
				...
				<p>
					...
					described above. We use Google Analytics to help us understand how our customers use the Site--you
					...
					https://tools.google.com/dlpage/gaoptout. Finally, we may also share your Personal Information to
				...
				<p>
					...
					exercise this right, please contact us through the contact information below. Additionally, if you
					are a European resident we note that we are processing your information in order to fulfill
				...
				<p>
					...
					make a complaint, please contact us by e-mail at hi@milktype.co.
				</p>
			</Container>
		</Layout>
	);
