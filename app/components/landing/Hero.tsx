...
export function Hero() {
	return (
		<Container className="py-8 md:py-16 flex flex-col items-center gap-y-16 md:flex-row">
			<div className="flex flex-col items-center md:items-start space-y-5 self-center text-4xl lg:text-5xl text-cocoa-120 leading-tight font-medium pr-8 w-3/5 lg:w-5/12">
				<h1 className="text-center md:text-left">
					<span className="whitespace-nowrap">creations for</span>
					<br className="md:hidden" />{" "}
					<span className="whitespace-nowrap">
						people we <HeartIcon className="inline-flex ml-1 h-6 lg:h-8 fill-accent" />
					</span>
				</h1>
